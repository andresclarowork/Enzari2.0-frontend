    ...
    <section className="bg-white border-radius-[32px] mt-4 sm:mt-8 md:mt-12 lg:mt-[120px] pb-4 sm:pb-8 md:pb-12 lg:pb-[120px]" style={{ backgroundColor: '#F4F4F4' }}>
      <div className="px-2 sm:px-4 md:px-6 lg:px-[100px]">
        <div style={{ maxWidth: '1440px', margin: '0 auto' }}>
          ...
          {/* Projects Grid */}
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-4 sm:gap-6 md:gap-6 lg:gap-10 justify-center items-start mx-auto px-4 sm:px-6 md:px-8 lg:px-0" style={{ maxWidth: '1240px' }}>
            {projects.map((project) => (
              <div key={project.id} className="group cursor-pointer transition-all duration-300 hover:transform hover:-translate-y-2 flex flex-col" style={{ gap:'20px md:25px', borderRadius: '32px' }}>
                {/* Project Image */}
                <div 
                ...
                {/* Project Info */}
                <div className="flex flex-col w-full max-w-[415px] px-2 sm:px-0 md:px-0" style={{ gap: '16px md:20px' }}>
                  <h3 
                    className="text-xl sm:text-2xl md:text-2xl lg:text-4xl xl:text-[28px] leading-tight"
                    style={{
                      fontFamily: 'var(--font-inter-tight)',
                      fontWeight: 500,
                      fontStyle: 'medium',
                  ...
                  <p 
                    className="text-sm sm:text-base md:text-base lg:text-xl xl:text-[18px] leading-relaxed"
                    style={{
                      fontFamily: 'var(--font-inter-tight)',
                      fontWeight: 400,
                      fontStyle: 'regular',
