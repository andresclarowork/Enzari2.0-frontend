...
export function ProductDesign() {
  ...
  return (
    <section className="flex flex-col lg:flex-row max-w-[1440px] mx-auto gap-8 sm:gap-12 md:gap-16 lg:gap-20 px-4 sm:px-6 md:px-8 lg:pl-[100px] lg:pr-[100px] pt-8 sm:pt-12 md:pt-16 lg:pt-[120px] bg-white">
      <div className="flex flex-col lg:flex-row w-[100%] justify-between gap-8 sm:gap-12 md:gap-16 lg:gap-0">
        
        <div className="flex flex-col gap-4 sm:gap-6 md:gap-8 lg:gap-[23px] max-w-full lg:max-w-[593px] order-1 lg:order-1">
        ...
        <div className="flex rounded-[16px] sm:rounded-[20px] md:rounded-[24px] lg:rounded-[32px] max-w-full lg:max-w-[597px] overflow-hidden order-2 lg:order-2">
          <Image
