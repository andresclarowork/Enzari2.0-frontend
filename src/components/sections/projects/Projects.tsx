    ...
    <section className="bg-white border-radius-[32px]">
      <div className="px-2 sm:px-4 md:px-6 lg:px-[100px]">
        <div style={{ maxWidth: '1440px', margin: '0 auto' }}>
          ...
          <div className="flex flex-wrap justify-center pt-[60px] pb-[40px] gap-5">
          ...
          <div className="flex flex-col gap-4 sm:gap-6 md:gap-8 lg:gap-10 justify-center items-center mx-auto" style={{ maxWidth: '1240px' }}>
            ...
            {filteredProjects.find(p => p.id === 3) && (
              <div className="w-full">
                <div className="group cursor-pointer transition-all duration-300 hover:transform hover:-translate-y-2 flex flex-col" style={{ gap:'25px', borderRadius: '32px' }}>
                  {/* Project Image */}
                  <div 
